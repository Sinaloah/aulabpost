<x-layout>
    <header class="container-fluid p-0 m-0">
        <div class="row m-0 cstm-index-box min-vh-100 cstm-index-bg position-relative cstm-index-padding-bottom">
            <div class="cstm-show-bg-grain"></div>
            <div class="cstm-index-bg-frame"></div>
            <div class="col-12 d-flex justify-content-center p-0">
                <h1 class="cstm-index-title">Tutti gli articoli per: {{$query}}</h1>
            </div>
            ...
            @endif
            @endforeach
            <div class="d-flex justify-content-center cstm-paginator-box">
