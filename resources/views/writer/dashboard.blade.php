    ...
    <header class="container-fluid h-100 p-0 m-0">
        <div class="row m-0 min-vh-100 cstm-dash-bg position-relative">
            ...
            <div class="col-12 d-flex justify-content-center p-0 position-relative">
                <h1 class="cstm-index-title">Bentornato Redattore</h1>
            </div>
            @if(session('message'))
            ...
            <div class="col-12 cstm-dash-col my-3">
                ...
                <h2 class="fs-5 pb-2 text-uppercase custom-fw-bold">Non ci sono articoli in fase di revisione</h2>
                @else
                <h2 class="pb-2 text-uppercase custom-fw-bold fs-5">Articoli in fase di revisione:</h2>
